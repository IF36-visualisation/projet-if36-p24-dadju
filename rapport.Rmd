...
En ajoutant la popularité de l'ensemble des films de même genre, on obtient un bar chart représentant la popularité de l'ensemble des films du dataset, répartie par genre. 
...
Ainsi, le premier graphique contient les genres dont la popularité maximale est supérieure à 500. 
...
box_plot_pop1 <- ggplot(data = data_genre_and_pop1, aes(x = genre, y = popularity)) +
    ...
    labs(x = "Genres", y = "Popularité", title = "Distribution de la popularité par genre de film") +
    theme(axis.text.x = element_text(angle = 45, hjust = 1))
