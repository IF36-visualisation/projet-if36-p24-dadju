...
Au cours du prétraitement, nous avons constaté la présence de textes JSON dans la variable de compagnie de production. De ce fait, nous avons créer une fonction pour nettoyer la colonne. Ensuite, nous devons compter le nombre de fois qu’un pays intervient dans la réalisation d’un film à une année donnée et le représenter.
