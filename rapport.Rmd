...
```{r création du graphique de Walt Disney Pictures }
...
```{r creation du graphique de Warner Bros. }
...
```{r creation du graphique de Canal+}
...
Pour le pays de production américain, nous constatons que les mots les plus fréquents retrouvés dans les nuages de mots des États-Unis sont similaires à ceux retrouvés dans les compagnies de production américaines. Cependant, cette observation n'a pas été très intéressante car elle n'a fourni aucune information pertinente.
...
Pour le pays de production français, nous observons aussi que les mots les plus fréquents retrouvés dans les nuages de mots de la France sont similaires à ceux retrouvés dans les compagnies de production françaises et américaines étant donné son rôle dans la promotion des films. Cependant, cette observation n'a pas été très intéressante car elle n'a fourni aucune information pertinente.
